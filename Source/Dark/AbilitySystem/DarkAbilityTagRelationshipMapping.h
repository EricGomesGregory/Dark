...
#include "DarkAbilityTagRelationshipMapping.generated.h"


/** 
 * FDarkAbilityTagRelationship
 * 
 *	Struct that defines the relationship between different ability tags 
 */
USTRUCT()
struct FDarkAbilityTagRelationship
{
	GENERATED_BODY()
...
/**
 * UDarkAbilityTagRelationshipMapping
 * 
 *	Mapping of how ability tags block or cancel other abilities
 */
UCLASS()
class DARK_API UDarkAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FDarkAbilityTagRelationship> AbilityTagRelationships;
};
