...
#include "Dark/Camera/DarkPenetrationAvoidanceFeeler.h"
#include "DarkCameraMode_ThirdPerson.generated.h"

class UCurveVector;


/**
 * UDarkCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class DARK_API UDarkCameraMode_ThirdPerson : public UDarkCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FDarkPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
