...
namespace DarkGameplayTags
{
	...
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_DamageSelfDestruct);
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_DamageImmunity);
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_FellOutOfWorld);
	...
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_Death);
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_Reset);
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_RequestReset);
	
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Damage);
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Heal);
	
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cheat_GodMode);
	DARK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cheat_UnlimitedHealth);
